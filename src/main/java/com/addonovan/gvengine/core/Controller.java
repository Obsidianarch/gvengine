...
/**
 * A simple implementation of a controller. Based around a camera for position and rotation controls, the controller will control the camera, even if the camera
 * is not actively being looked through. This allows for the camera to serve as an NPC's "view" despite the fact that the game will (most likely) never view the
 * world through the NPC's "eyes."
 *
 * @author Austin
 * @version 14.03.30
 * @see Camera
...
public class Controller
{
    ...
    /**
     * Moves the camera to the right, relative to the direction the camera is currently looking.
     *
     * @param distance
