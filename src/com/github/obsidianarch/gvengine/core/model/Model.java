...
/**
 * A set of vertices, normals, and faces saved in a file that is loaded by a ModelLoader
 * and can be rendered as a VertexBufferObject.
 * 
 * @author Austin
 * 
 * @since 14.04.19
...
public class Model {
    ...
    /**
     * Constructs a new Model with no vertex, normal, or face data. The Model will have no
     * normals and no alpha channel in its colors.
     * 
     * @since 14.04.19
     * @since 14.04.19
     */
    ...
    /**
     * Validates the data contained by the underlying VertexBufferObject that is used by
     * this model and updates it to any changed code.
     * 
     * @since 14.04.19
     * @since 14.04.19
     */
    ...
    /**
     * Checks to make sure the data for this Model is validated, if not then the data is
     * validated then rendered.
     * 
     * @since 14.04.19
     * @since 14.04.19
     */
